...
public class Abc
{
	 ...
	 * @param lfDrData        UNDX用パラメータ１
	 * @param lfBoundData     UNDX用パラメータ２
	 * @throw AbcException
	 * @author kobayashi
	 * @since 2017/2/20
	 * @version 0.1
...
//				memcpy(plfX1, plfX0, sizeof(double)*iAbcVectorDimNum);
	...
	public void vModifiedHookeJeevesMethod( double[] plfStepSize, double[] plfX1, double[] plfX2, double[] plfX0 )
	{
		int i, j, k;
		int iCounter = 1000;
		double lfRes = 0.0;
	...
	public boolean bHJEmStep( double[] plfX1, double[] plfX0, double[] plfStepSize )
	{
		double lfObjFunc = 0.0;
		double lfFuncMin = Double.MAX_VALUE;
		double lfXi;
